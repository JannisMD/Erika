...
/*
app.get('/bpmn-js-seed-master/bower_components/bpmn-js/dist/index-async.js', function(req,res){
  console.log("ich bin in der methode");
  var antwort = {"message":"Erfolgreich übermittelt"};
  res.json(antwort);
});
app.get('/bpmn-js-seed-master/bower_components/bpmn-js/dist/bpmn-viewer.js', function(req,res){
  console.log("ich bin in der methode2");
  var antwort = {"message":"Erfolgreich übermittelt"};
  res.json(antwort);
});*/
...
app.get('/Einkaufmuster1.bpmn', function(req,res){
  console.log('Einkaufsmuster1 wird abgefragt');
